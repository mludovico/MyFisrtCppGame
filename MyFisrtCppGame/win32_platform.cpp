...
internal int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd) {
	...
	// Create window
	HWND window = CreateWindow(window_class.lpszClassName, "My first cpp game",
